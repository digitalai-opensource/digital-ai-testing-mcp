...
This server reads a `DIGITAL_AI_ACCESS_KEY` from environment variables or a `.env` file. This key grants access to your Digital.ai Continuous Testing environment.
...
- Vulnerabilities in the Digital.ai Continuous Testing platform itself — report those to [Digital.ai Support](https://support.digital.ai).
