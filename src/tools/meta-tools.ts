...
const REGISTERED_TOOLS = [
  ...
  'download_repository_file', 'update_repository_file', 'delete_repository_file',
  // Browsers
  ...
  'upload_provisioning_profile', 'download_provisioning_profile',
  ...
  server.tool(
    ...
    async () => {
      ...
      const lines = [
        ...
        '  Provisioning       — list, detail, upload, download, delete (5 tools)',
        '  Backup             — create (1 tool)',
        '  Health             — environment, iOS-readiness, Android-readiness, agent-status (4 tools)',
        '  Reporting          — list+date-filter, find-latest, grouped, summary, attachments, delete, active-executions (13 tools)',
