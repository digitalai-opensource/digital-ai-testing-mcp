...
| Tool | What it does | Admin Required? |
|---|---|---|
| `get_test_boilerplate` | Generate a complete, pre-configured Appium test script. See [Boilerplate Generation](../README.md#boilerplate-generation) for full documentation. | Any |
